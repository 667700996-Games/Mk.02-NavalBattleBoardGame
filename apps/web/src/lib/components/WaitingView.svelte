...
<section class="waiting panel" aria-labelledby="waiting-title">
  <div class="waiting__radar" aria-hidden="true">
  ...
  <p class="muted">
    초대 링크나 작전 코드를 공유하십시오. 두 번째 지휘관이 합류하면 바로 함대 배치로 전환됩니다.
  </p>
...
<style>
  ...
  .waiting__radar::after {
    ...
    height: 1px;
    content: '';
    background: rgba(57, 224, 235, 0.15);
  }
  .waiting__radar::after {
  ...
  .waiting__sweep {
    ...
    background: conic-gradient(from 270deg at 100% 0, rgba(57, 224, 235, 0.4), transparent 40deg);
