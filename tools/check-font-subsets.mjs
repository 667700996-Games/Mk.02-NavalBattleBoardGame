...
const maximumKoreanPayload =
  performanceBudgets.artifact.fonts.requiredGlyphPayloadBytes ??
  Math.min(...Object.values(performanceBudgets.tiers).map((tier) => tier.fontBytes));
